...
let start = () => {
    ...
    if(first==0){
        ...
        document.querySelector('.hpm').innerHTML = Math.round(hpm * 100) / 100
        document.querySelector('.avg').innerHTML = Math.round(avg * 100) / 100
    }
    ...
    document.querySelector('.quiz1').innerHTML = data.quiz1.type.text
